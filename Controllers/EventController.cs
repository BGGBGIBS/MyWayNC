...
namespace MyWayNC.Controllers
{
    public class EventController : Controller
    {
        ...
        {
            var myWayContext = _context.Events.Include(@event => @event.Institution).Include(@event => @event.Occupation);
        ...
        public async Task<IActionResult> Details(long? id)
        {
            ...
            var @event = await _context.Events
                .Include(@event => @event.Institution)
                .Include(@event => @event.Occupation)
